...
I am a Lecturer in Security and Protection Science based in [Linguistics and English Language, Lancaster University](https://lancaster.ac.uk/linguistics/){target="_blank"}, where I am affiliated with the [Phonetics Lab](https://phoneticslab.github.io/){target="_blank"} and the [Forensic Linguistics, Cybersecurity and Technology Research Group (FACTOR)](https://wp.lancs.ac.uk/factor/){target="_blank"}. At [Security Lancaster](https://www.lancaster.ac.uk/security-lancaster/){target="_blank"}, I co-lead the theme [*Boundaries of Being*](https://www.lancaster.ac.uk/security-lancaster/research/themes/series1/boundaries-of-being/){target="_blank"}. I am also a member of the [Data Science and AI Institute @ Lancaster](https://www.lancaster.ac.uk/data-science-and-artificial-intelligence/){target="_blank"}. I am the PhD Abstracts Editor for [*The International Journal of Speech, Language and the Law*](https://utppublishing.com/journal/ijsll){target="_blank"}.
